...
(function () {
    ...
    var _stateSettings = {
        ...
        MD: {
            ...
            zoomSettings: { maxOffset: [30, 15, 8, 4, 2, 1, 1, 1, 1, 1], excludeRoadTypes: [['St'], ['St'], ['St'], ['St'], [], [], [], [], [], [], []] },
            fcMapLayers: [
                { layerID: 0, fcPropName: 'FUNCTIONAL_CLASS', idPropName: 'OBJECTID', outFields: ['OBJECTID', 'FUNCTIONAL_CLASS', 'ID_PREFIX', 'MP_SUFFIX'], roadTypeMap: { Fw: [1], Ew: [2], MH: [3], mH: [4], PS: [5, 6], St: [7] }, maxRecordCount: 1000, supportsPagination: false }
            ],
        ...
        NC: {
            ...
            isBusinessRoute: function (feature) {
                var qual = feature.attributes.RouteQualifier.toString();
                return qual === '9';
            }
        },
        ND: {
        ...
        OH: {
            ...
            fcMapLayers: [
                {
                    layerID: 8, fcPropName: 'FUNCTION_CLASS_CD', idPropName: 'ObjectID', outFields: ['FUNCTION_CLASS_CD', 'ROUTE_TYPE', 'ROUTE_NBR', 'ObjectID'],
